...
\begin{figure}[h!]
  \makebox[\textwidth]{\includegraphics[width=20cm]{ui_settings_page.PNG}}
...
\begin{figure}[h!]
  \makebox[\textwidth]{\includegraphics[width=20cm]{ui_myjobs_client.PNG}}
...
\begin{figure}[h!]
  \makebox[\textwidth]{\includegraphics[width=20cm]{ui_jobinfo_tech1.PNG}}
